...
?>
    <div id="container">
        ...
        <div id="header_main">Buscador de Dominios</div><div id="header_right"></div></div>
        <div id="content">
<?php
}
...
?>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
				<table class="dtable2">
                <tr><th colspan="5">Busca tu Dominio</th></tr>
				<tr><td colspan="5"><center>www.<input name="domain" type="text" size="35" /></center></td></tr>
                <tr><th colspan="5">seleccione la extención</th></tr>
				<tr>
            <?php
            	$i = 0;
...
?>
        ...
        <div id="footer"><a href="http://localhost/matutewebsite/" target="_blank">Matute - Agencia Publicitaria</a></div>
    </div>
